...
{
    /// <summary>
    /// Produces tanks and trucks.
    /// </summary>
    [CreateAssetMenu(fileName = "VehicleFactoryData", menuName = "IFC/Buildings/VehicleFactory", order = 1)]
    public class VehicleFactoryData : ScriptableObject
    {
        [Header("Basic Info")]
        [SerializeField] private string _buildingName = "VehicleFactory";
