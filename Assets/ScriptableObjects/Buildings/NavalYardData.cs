...
{
    /// <summary>
    /// Produces naval units if city is coastal.
    /// </summary>
    [CreateAssetMenu(fileName = "NavalYardData", menuName = "IFC/Buildings/NavalYard", order = 1)]
    public class NavalYardData : ScriptableObject
    {
        [Header("Basic Info")]
        [SerializeField] private string _buildingName = "NavalYard";
