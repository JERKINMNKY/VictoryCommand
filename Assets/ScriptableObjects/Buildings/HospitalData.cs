...
{
    /// <summary>
    /// Heals wounded troops post-battle.
    /// </summary>
    [CreateAssetMenu(fileName = "HospitalData", menuName = "IFC/Buildings/Hospital", order = 1)]
    public class HospitalData : ScriptableObject
    {
        [Header("Basic Info")]
        [SerializeField] private string _buildingName = "Hospital";
